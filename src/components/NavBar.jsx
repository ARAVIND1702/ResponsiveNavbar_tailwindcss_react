  ...
  return (
    <div className='text-white flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4'>
        ...
        <ul className='hidden md:flex '>
          <li className='p-4 font-light hover:text-[#00df98] transition duration-500 ease-out hover:ease-in'>Home</li>
          <li className='p-4 font-light hover:text-[#00df9a] transition duration-500 ease-out hover:ease-in'>Contact</li>
          <li className='p-4 font-light hover:text-[#00df9a] transition duration-500 ease-out hover:ease-in'>About</li>
        ...
        <div className= {!nav ? 'fixed top-0 h-full w-[60%] left-[-100%] ease-in-out duration-700'  : 'fixed left-0 top-0 w-[60%] h-full border-r border-r-[#06555b] bg-gradient-to-l from-[#00956630] to-[#00df9800] ease-in-out duration-700 '}>
        <ul className='pt-20' >
        <li className='p-4   font-light  hover:text-[#00df98] transition duration-500 ease-out hover:ease-in'>Home</li>
          <li className='p-4 font-light hover:text-[#00df9a] transition duration-500 ease-out hover:ease-in'>Contact</li>
          <li className='p-4 font-light hover:text-[#00df9a] transition duration-500 ease-out hover:ease-in'>About</li>
